...
const PublicProfile = () => {
    ...
    if (isLoading) {
        return (
            <div className="container" style={{ textAlign: 'center', padding: '4rem 0' }}>
                <p style={{ color: 'var(--primary)' }}>Loading profile data...</p>
            </div>
        );
    }
    ...
    if (error || !profile) {
        return (
            <div className="container" style={{ textAlign: 'center', padding: '4rem 0' }}>
                <h2 className="heading-2" style={{ color: 'var(--error, #d32f2f)' }}>Profile Error</h2>
                <p className="text-lead">{error || 'This candidate profile does not exist.'}</p>
    ...
    return (
        <div className="container" style={{ maxWidth: '900px', padding: '2rem 1rem' }}>
            ...
            <div className="print-hide" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                <Link to="/" style={{ color: 'var(--primary)', fontWeight: 500 }}>&larr; Back to Home</Link>
                <button onClick={handlePrint} className="btn-outline" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.5rem 1rem' }}>
