            ...
            <div className="glass-card animate-fade-in" style={{ padding: '3rem' }}>
                ...
                <form onSubmit={handleSubmit}>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
                        ...
                        <div className="form-group">
                            <label className="form-label">Height in feet and centimeter*</label>
                            <input type="text" name="height" className="form-control" value={formData.height} onChange={handleChange} placeholder="e.g. 5'8&quot; / 172cm" required />
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" name="complexion" className="form-control" value={formData.complexion} onChange={handleChange} />
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" name="category" className="form-control" value={formData.category} onChange={handleChange} placeholder="e.g. Catholic, Protestant, etc." />
                        </div>
